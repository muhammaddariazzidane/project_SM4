...
class Komentar_model extends CI_Model
{
  ...
  {
    $this->db->select('user.id as uID, user.username, user.image, comment_berita.id, comment_berita.post_at, comment_berita.body, comment_berita.user_id');
  ...
  {
    $this->db->select('user.id as uID, user.username, user.image, comment_kegiatan.id, comment_kegiatan.post_at, comment_kegiatan.body, comment_kegiatan.user_id');
