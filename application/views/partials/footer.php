      ...
      <div class="col-xl-3 col-lg-3 col-md-6">
        <div>
          ...
          <form accept="" method="post">
            ...
            <?= $this->session->username ? '<button id="btnNotif" class="btn btn-warning mt-3" type="submit">Kirim</button>' : '<a href="' . base_url('auth') . '" class="btn btn-primary mt-3">Login</a>' ?>
...
<script>
  const Notif = document.getElementById('btnNotif').addEventListener('click', () => {
