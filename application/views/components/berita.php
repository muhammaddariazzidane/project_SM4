<section class="hero-section ">
  <div class="container">
    <div class="row justify-content-center mx-auto text-center">
      <div class="col-md-8">
        <h2 class="section-title mb-5" data-aos="fade-down">Berita Terbaru</h2>
        <?php if ($berita) : ?>
          <p class="fs-4 fw-bold" data-aos="fade-right"><?= $berita[0]->nama_berita ?> </p>
          <img data-aos="flip-up" data-aos-duration="1000" src="<?= base_url('assets/img/berita/') . $berita[0]->foto_berita ?>" alt="Hero Image" class="hero-img object-fit-contain">
